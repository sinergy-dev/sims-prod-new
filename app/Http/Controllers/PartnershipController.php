...
class PartnershipController extends Controller
{
    ...
    public function getCountDashboard(Request $request)
    {
        ...
        return collect([
            ['title' => 'Total Partner' ,'count' => $count_partner, 'color' => 'bg-info'],
            ['title' => 'Engineer Certification' ,'count' => $eng_certification, 'color' => 'bg-warning'],
            ['title' => 'Sales Certification' ,'count' => $sales_certification, 'color' => 'bg-success'],
        ]);
    }
