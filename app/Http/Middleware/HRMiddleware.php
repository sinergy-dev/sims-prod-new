...
class HRMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ( Auth::check() && Auth::User()->id_position == 'MANAGER'  && Auth::check() && Auth::User()->id_division == 'POS' || Auth::User()->id_division == 'HCM' || Auth::User()->id_division == 'OPD')
        {
            return $next($request);
        } 
        ...
        elseif ( Auth::User()->id_position == 'DIRECTOR' && Auth::User()->id_division == 'TECHNICAL' ) 
        {
            return $next($request);  
        } 
        ...
        elseif ( Auth::User()->id_position == 'VP' && Auth::User()->id_division == 'FINANCE' ) 
        {
            return $next($request);  
        } 
