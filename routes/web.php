...
Route::group(['middleware' => ['auth']], function () {
	//quote list
	Route::get('sales/quoteDetail/{id}', 'QuoteController@detailQuotation')->name('detail_quote');;
	...
	//saveMode light & dark
	Route::post('/saveMode','TestController@saveMode');
	...
	Route::get('/admin/detailDraftPR/{id}', 'PrDraftController@detailDraftPR');
	...
	Route::get('/PMO/projectDetail/{id_pmo}','PMProjectController@pmoPmDetail');
