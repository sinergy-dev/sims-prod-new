            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-xxl-8 mb-6 order-0">
                  <div class="card">
                    <div class="d-flex align-items-start row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h6 class="card-title text-primary mb-3">Congratulations John! 🎉</h6>
                          <p class="mb-6">
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h6 class="card-title mb-3">$12,628</h6>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h6 class="card-title mb-3">$4,679</h6>
                      ...
                      <div class="col-lg-8">
                        <div class="card-header d-flex align-items-center justify-content-between">
                          <div class="card-title mb-0">
                            <h6 class="m-0 me-2">Total Revenue</h6>
                          </div>
                          <div class="dropdown">
                            <button
                              class="btn p-0"
                    ...
                    <div class="col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h6 class="card-title mb-3">$2,456</h6>
                    ...
                    <div class="col-6 mb-6">
                      <div class="card h-100">
                        <div class="card-body">
                          ...
                          <h6 class="card-title mb-3">$14,857</h6>
                          ...
                          <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column gap-10">
                            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                              <div class="card-title mb-6">
                                <h6 class="text-nowrap mb-1">Profile Report</h6>
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 order-0 mb-6">
                  <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                      <div class="card-title mb-0">
                        <h6 class="mb-1 me-2">Order Statistics</h6>
                ...
                <div class="col-md-6 col-lg-4 order-2 mb-6">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h6 class="card-title m-0 me-2">Transactions</h6>
                      <div class="dropdown">
                        <button
                          class="btn text-muted p-0"
                          type="button"
