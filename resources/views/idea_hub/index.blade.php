...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <section class="content">
            ...
            @endif
            <div class="row" style="margin-bottom:10px" id="filtercard">
                <div class="col-md-3" >
                    <div class="form-group">
                        <label>Range Date Idea : </label>
                        <button type="button" class="btn btn-sm btn-outline-secondary pull-left" style="width:100%" id="inputRangeDate">
