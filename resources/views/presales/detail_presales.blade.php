   ...
   <div class="row">
        ...
        <button class="btn btn-primary" type="button" name="next" class="active">Next Step</button>
          ...
          <div class="col-md-6">
            <div class="card mb-3">
              ...
              <div class="card-body py-2 small">
                <h6 class="pull-left">{{ $tampilkan->name_contact}}</h6>
                <h6 class="pull-right">Owner : {{ $tampilkan->name}}</i></h6>
              </div>
          ...
          <div class="row margin-top">
            <div class="col-md-6">
              <div class="card mb-3">
              <h6 class="margin-left-right margin-top">Solution Design</h6>
            <hr class="">
            ...
            <div class="col-md-6">
          <div class="card mb-3">
              <h6 class="margin-left-right margin-top">Tender Project</h6>
            <hr class="">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Propossed Design</h6>
        </div>
