    ...
    <div class="row">
        <div class="col-lg-8 col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h6 class="box-title">Total Amount Claim</h6>
            </div>
            <div class="box-body">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h6 class="box-title">Claim Pending/Claim Transfer</h6>
            </div>
            <div class="box-body">
    ...
    <div class="row">
        <div class="col-lg-8 col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h6 class="box-title">Total Claim</h6>
            </div>
            <div class="box-body">
              <div class="row">
        ...
        <div class="col-lg-4 col-xs-12">
          <div class="box box-warning">
            <div class="box-header with-border">
              <h6 class="box-title">Status Claim</h6>
            </div>
            <div class="box-body">
              @if($counts >= 1)
                <div class="card-body">
  ...
  @elseif(Auth::User()->id_division == 'FINANCE')
    ...
    <div class="row">
        <div class="col-lg-8">
          <div class="box box-success">
            <div class="box-header with-border">
              <h6 class="box-title">Total Lead Register</h6>
            </div>
            <div class="box-body">
            <div class="row">
              <div class="col-lg-12 col-xs-12">
  ...
  @else
    <div class="row">
        ...
        <div class="col-lg-6 col-xs-6">
          	<div class="box box-primary">
            <div class="box-header with-border">
              <h6 class="box-title"><i>TOP 5 (WIN Projects)</i></h6>
              <h6 class="box-title pull-right"><b>SIP</b></h6>
            </div>
            <div class="box-body">
              <?php $no_sip = 1; ?>
      ...
      @if(Auth::User()->id_position == 'DIRECTOR' || Auth::User()->id_division == 'TECHNICAL' && Auth::User()->id_position == 'MANAGER')
        <div class="col-lg-6 col-xs-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h6 class="box-title"><i>TOP 5 (WIN Projects)</i></h6>
              <h6 class="box-title pull-right"><b>MSP</b></h6>
            </div>
            <div class="box-body">
              <?php $no_msp = 1; ?>
    ...
    <div class="row">
      	<div class="col-lg-8 col-xs-12">
	        <div class="box box-primary">
	          <div class="box-header with-border">
	            <h6 class="box-title">Total Amount Lead Register (Deal Price)</h6>
	          </div>
	          <div class="box-body">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-xs-12">
        <div class="box box-primary">
          <div class="box-header with-border">
            <h6 class="box-title">Status Lead Register</h6>
          </div>
          <div class="box-body">
