        ...
        <div class="col-md-3 col-xs-12">
          <div class="card card-primary mb-4">
            ...
            <div class="card-body">
              ...
              <button id="" class="btn btn-sm btn-primary btn-block" onclick="customFilter()"><i class="bx bx-filter"></i> Filter</button>
              <button id="" class="btn btn-sm btn-info btn-block" onclick="resetFilter()"><i class="bx bx-refresh"></i> Reset</button>
            </div>
          </div>
        </div>
        <div class="col-md-9 col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="nav-item" id="nav-tab-table"><a class="nav-link active" href="#table" data-bs-toggle="tab">Table</a></li>
              <li class="nav-item"><a class="nav-link" href="#chart" data-bs-toggle="tab">Chart</a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane show active" id="table">
                <div class="card card-primary mb-4" id="card_mandays">
                  <div class="card-header bg-primary with-border">
                    <h6 class="card-title text-white" style="color: white;">Summary of Mandays <span id="title_summary_year"></span>
                      <span id="filterSumPoint" class="pull-right"><i class="bx bx-circle" style="color: red;"></i> <span style="color: white">not ready to filter..</span></span>
                    </h6>
                  </div>
                  <div class="card-body">
                        ...
                        <div class="input-group">
                          <input id="searchBarMandays" type="text" class="form-control" placeholder="ex: Search Name..." onkeyup="searchCustom('tbSummaryMandays','searchBarMandays')">
                            ...
                            <ul class="dropdown-menu" id="selectShowEntry">
                              <li><a class="dropdown-item" href="#" onclick="changeNumberEntries('tbSummaryMandays',10)">10</a></li>
                              <li><a class="dropdown-item" href="#" onclick="changeNumberEntries('tbSummaryMandays',25)">25</a></li>
                              <li><a class="dropdown-item" href="#" onclick="changeNumberEntries('tbSummaryMandays',50)">50</a></li>
                              <li><a class="dropdown-item" href="#" onclick="changeNumberEntries('tbSummaryMandays',100)">100</a></li>
                            </ul>
                        </div>
                      </div>
                ...
                <div class="row mt-4">
                  <div class="col-md-6 col-xs-12">
                    <div class="card card-primary mb-4" id="card_sbe" style="display:none;">
                      <div class="card-header bg-primary with-border">
                        <h6 class="card-title text-white" style="color: white;">Summary of SBE</h6>
                      </div>
                      <div class="card-body">
                        <div class="row mb-4">
                  ...
                  <div class="col-md-6 col-xs-12">
                    <div class="card card-primary mb-4" id="card_pid" style="display:none">
                      <div class="card-header bg-primary with-border">
                        <h6 class="card-title text-white" style="color: white;">Assign PID</h6>
                      </div>
                      <div class="card-body">
                        <div class="row mb-4">
                          <div class="col-md-12 col-xs-12 pull-right">
                ...
                <div class="row mb-4" id="card_definition" style="display:none;">
                </div>
              </div>
              ...
              <div class="tab-pane" id="chart">
                <div class="alert alert-info alert-dismissible" role="alert">
                  <h4 class="alert-heading d-flex align-items-center flex-wrap gap-1">
                    <span class="alert-icon rounded-circle"><i class="icon-base bx bx-info-square"></i></span>Alert
                  </h4>
                  <hr>
                  <p class="mb-0">Please filter <b>division</b> first to show the data!.</p>
                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" fdprocessedid="haa3dd"></button>
                </div>
                <div class="card card-primary mb-4">
                  <div class="card-header bg-primary" style="color:white">
                    <h6 class="card-title text-white">Cummulative Mandays (Status Done)</h6>
                  </div>
                  <div class="card-body">
                ...
                <div class="card card-primary mb-4">
                  <div class="card-header bg-primary" style="color:white">
                    <h6 class="card-title text-white">Remaining <span id="span-remaining"></span> (Status Done)</h6>
                  </div>
                  <div class="card-body">
                    <div class="containercardRemaining" style="width:100%;max-width: 100%;overflow-x: scroll;">
                      <div id="card-remaining" style="height:600px">
                      </div>
                    </div>
                ...
                <div class="row mb-4">
                  <div class="col-md-4 col-xs-12" style="display: none;" id="card-level-timesheet">
                    <div class="card card-primary mb-4">
                      <div class="card-header bg-primary" style="color:white">
                        <h6 class="card-title text-white">Level <span id="textLevel"></span></h6>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-4 col-xs-12" style="display: none;" id="card-status-timesheet">
                    <div class="card card-primary mb-4">
                      <div class="card-header bg-primary" style="color:white">
                        <h6 class="card-title text-white">Status <span id="textStatus"></span></h6>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-4 col-xs-12" style="display: none;" id="card-schedule-timesheet">
                    <div class="card card-primary mb-4">
                      <div class="card-header bg-primary" style="color:white">
                        <h6 class="card-title text-white">Schedule <span id="textSchedule"></span></h6>
                      </div>
                      <div class="card-body">
                ...
                <div class="row mb-4">
                  <div class="col-md-6 col-xs-12" style="display: none;" id="card-task-timesheet">
                    <div class="card card-primary mb-4">
                      <div class="card-header bg-primary" style="color:white">
                        <h6 class="card-title text-white">Task <span id="textTask"></span></h6>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="col-md-6 col-xs-12" style="display: none;" id="card-phase-timesheet">
                    <div class="card card-primary mb-4">
                      <div class="card-header bg-primary" style="color:white">
                        <h6 class="card-title text-white">Phase <span id="textPhase"></span></h6>
                      </div>
                      <div class="card-body">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-sm btn-danger btn-sm" id="deleteManageAssign">Delete Assign</button>
              <button type="button" class="btn btn-sm btn-primary btn-sm" id="saveManageAssign">Save</button>
            </div>          
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function(){
        ...
        datatableSummary = $(tabId).find('#tbSummaryMandays').DataTable({
          ...
          columns: [
            { 
              title: 'Name',
              data: 'name',
              defaultContent: '-',  // Shows "-" if data is null or undefined
              render: function (data, type, row) {
                return `<a href="/timesheet/timesheet?nik=${row.nik}" class="text-primary text-decoration-none" target="_blank">${data || '-'}</a>`;
              }
            },
            { title: 'Planned', data: 'planned', defaultContent: '-' },
            { title: 'Actual', data: 'actual', defaultContent: '-' },
            { title: 'Threshold', data: 'threshold', defaultContent: '-' },
            { title: 'Billable', data: 'billable', defaultContent: '-' },
            { title: '%Billable', data: 'percentage_billable', defaultContent: '0%' },
            { title: 'Deviation', data: 'deviation', defaultContent: 'N/A' },
            { title: 'Activity Total', data: 'total_task', defaultContent: '0' },
          ],
          lengthChange: false,
          "pageLength": 50,
    ...
    if (accesable.includes('card_pid') || accesable.includes('card_sbe')) {
  ...
  var appendMonth = ""
    ...
    appendMonth = appendMonth + '<div class="row mb-4">'
  ...
  $.ajax({
    ...
    success:function(result){
      ...
      $.each(result,function(index,value){
        ...
        appendDefinition = appendDefinition + '  <div class="card card-primary mb-4">'
        appendDefinition = appendDefinition + '    <div class="card-header bg-primary">'
        appendDefinition = appendDefinition + '      <h6 class="card-title text-white" style="color:white">'+ index +'</h6>'
        appendDefinition = appendDefinition + '    </div>'
          appendDefinition = appendDefinition + '    <div class="card-body">'
      ...
      $("#card_definition").append(appendDefinition)
    }
  })
  ...
  function remainingChart(idCtx,value){
    ...
    const containerBodyRemaining = document.querySelector('#card-remaining');
  ...
  function duplicateCanvasRemaining(url,param,position){
    $.ajax({
      ...
      success:function(results){
        ...
        $.each(results,function(index,value){
          if (typeof(value) == "object") {
            $.each(value,function(idx,values){
              ...
              $("#card-remaining").append(duplicateCanvas)
        ...
        $("#card-remaining").css("width","1990px")

        var $myDiv        = $("#card-remaining");
