...
<body class="bodyEmail">
			...
			<tr>
				...
				<td width="10%">
					<table style="border-collapse: collapse;text-align: center;border: solid 0.5px black;padding-top: 5px;">
						...
						<tr>
							<!-- loop date-->
							<td style="border:solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[0]}}</td>
							<td style="border: solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[1]}}</td>
							<td style="border: solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[2]}}</td>
							<td style="border: solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[3]}}</td>
							<td style="border: solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[4]}}</td>
							<td style="border: solid 0.5px black;height: 40px;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('dmy')[5]}}</td>
							<!---->
						</tr>
					</table>
				</td>
				...
				<td width="20%">
					<table style="border-collapse: collapse;text-align: center;border: solid 0.5px black;padding-top: 5px;" width="100%">
						...
						<tr>
							<td style="height: 40px">{{$data['settlement']['pid_details'][0]['name_project']->name_project}}</td>
						</tr>
					</table>
				</td>
			</tr>
		...
		@foreach($data['settlement']['pid_details'][0]['details'] as $value)
			@if($value->sub_category == 'Entertainment')
				<tr>
					...
					<!---->
					<td style="font-family: 'Lucida Sans', 'Lucida Grande', 'Lucida Sans Unicode', sans-serif;font-size: 7px;">
						{{$data['settlement']['pid_details'][0]['name_project']->code_company}}
					</td>
					<td style="font-family: 'Lucida Sans', 'Lucida Grande', 'Lucida Sans Unicode', sans-serif;font-size: 7px;">
					...
					<table style="border-collapse: collapse;" width="100%">
						...
						<tr>
							<td style="color:#3489cf;font-size: 12px;padding: 5px;position: relative;height: 50px;">
								<img src="{{$data['getSign'][3][0]['ttd']}}" style="width: 50px;height: 50px;left:0;top: 5;position: absolute;">	
								<i style="position:absolute;right: 0;">
									{{\Carbon\Carbon::parse($data['settlement']['date'])->format(' d - m')}}
								</i><br>
								<i style="position:absolute;right: 0;">{{\Carbon\Carbon::parse($data['settlement']['date'])->format('Y')}}
								</i>
							</td>
						</tr>
						<tr>
							<td>
								{{$data['getSign'][3][0]['name']}}<br>
								{{$data['getSign'][3][0]['position']}}
							</td>
						</tr>
					</table>
				</td>
		...
		<table class="table-content-people-sign">
			<tr>
				<td width="30%" style="padding: 5px;border-right: solid 0.5px black;border-left: solid 0.5px black;border-top: solid 0.5px black;vertical-align: top;text-align:justify;position: relative;">
					...
					<br><br><br><br><br>
					<img src="{{$data['getSign'][0]['ttd']}}" style="width: 50px;height: 50px;">
				</td>
				<td width="5%"></td>
				...
				<td width="30%" style="padding: 5px;border-right: solid 0.5px black;border-left: solid 0.5px black;border-top: solid 0.5px black;vertical-align: top;text-align: justify;height: 100px;position: relative;">
					...
					<img src="{{$data['getSign'][1]['ttd']}}" style="width: 50px;height: 50px;left: 25;top: 40;position: absolute;">
					<img src="{{$data['getSign'][2]['ttd']}}" style="width: 50px;height: 50px;right: 40;top: 40;position: absolute;">	
				</td> 
			</tr>
			<tr>
				<td width="30%" style="border-bottom: solid 0.5px black;border-right: solid 0.5px black;border-left: solid 0.5px black;padding: 5px;">
					{{$data['getSign'][0]['name']}}<br>
					{{$data['getSign'][0]['position']}}
				</td>
				<td width="5%"></td>
				<td width="30%" style="border-bottom: solid 0.5px black;border-right: solid 0.5px black;border-left: solid 0.5px black;padding: 5px;">
				</td>
				...
				<td width="30%" style="border-bottom: solid 0.5px black;border-right: solid 0.5px black;border-left: solid 0.5px black;padding: 5px;position: relative;">		
					<span style="position: absolute;left: 25;">{{$data['getSign'][1]['name']}}<br>{{$data['getSign'][1]['position']}}</span>
					<span style="position: absolute;right: 30;">{{$data['getSign'][2]['name']}}<br>{{$data['getSign'][1]['position']}}</span>
				</td>
			</tr>
		</table>
	</div>
	<div style="page-break-before: always;">
		...
		@foreach(array_chunk($arrayData, 4) as $row) 
		    <tr>
