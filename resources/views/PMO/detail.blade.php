...
@section('content')
    <section class="content-header">
        ...
        @if($id == NULL)
        @else
        <div style="background: red"><h6 style="padding: 16px;color: white">{{$detail->title}}</h6></div>
        @endif
        <ol class="breadcrumb">
                    ...
                    <div class="tab-content">
                        ...
                        @else
                            @foreach($phase as $p_parent)
                                ...
                                @endif
                                        <center><h6><b><span style="background-color: green;color: white"> -- Progress Table -- </span></b></h6></center>
                                        ...
                                        <center><h6><b><span style="background-color: red;color: white"> -- Problem Table -- </span></b></h6></center>
        ...
        <div class="modal fade" id="next_phase_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Next Phase</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
        ...
        <div class="modal fade" id="progress_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Engineer Progress</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Title</label>
        ...
        <div class="modal fade" id="problem_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Engineer Problem</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Title</label>
        ...
        <div class="modal fade" id="progress_edit" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Engineer Progress (Edit)</h6>
                        </div>
                        <div class="modal-body">
        ...
        <div class="modal fade" id="engineer_add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Member Add</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
        ...
        <div class="modal fade" id="leader_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Change Project Leader</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
