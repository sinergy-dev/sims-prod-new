...
<head>
  ...
  <style type="text/css">
    ...
    .table-implementation-header th{
      background-color: #5b9bd5;
      color: black;
    }

    .table-implementation-body th{
      background-color: #5b9bd5;
      color: black;
    }

    .table-implementation-body td:nth-child(1){
      text-align: center;
      vertical-align: middle;
    }

    .table-implementation-body td{
      vertical-align: middle;
    }
  ...
  <title>Project Budget Control - Implementation + Maintenance Service</title>
</head>
<body>
  ...
  @foreach($data[0]['sbe'] as $key => $dataSbe)
    @if($dataSbe->project_type == 'Implementation')
      <table class="table-implementation-header">
        <tr>
        ...
        <tr>
          <td>Project Owner</td>
          <td>:</td>
          <td style="text-align: left!important;">{{$data[0]['owner']}}</td>
        </tr>
        <tr>
          <td colspan="7" style="height: 10px;"></td>
        </tr>
      ...
      <!-- loop items-->
      <table class="table-implementation-body">
        @php
          ...
          @foreach($detail_sbe as $key_detail => $detail_item)
            @if($key_detail == 0)
              <tr class="border">
                ...
                <td rowspan="{{count($detail_sbe)}}" style="text-align:center;vertical-align: top;">{{$detail_item->item}}</td>
    ...
    @endif
      <br>
    @if($dataSbe->project_type == 'Maintenance')
    <div style="page-break-before:always;">
      ...
      <table class="table-maintenance-body">
          ...
          @foreach($dataSbe['items_sbe']['grouped_sums'] as $key_item => $grouped_item)
            ...
            <tr>
              ...
              <th style="position: relative;border:solid black 0.5px;">
                  <span style="position: absolute; left: 2;">IDR</span>
                  <span style="position: absolute; right: 2;">{{number_format($grouped_item['total_plan_sbe'],2)}}
                  </span>
                </th>
                <th style="position: relative;border:solid black 0.5px;">
                  <span style="position: absolute; left: 2;">IDR</span>
        ...
        <tr class="border">
          <th colspan="3"></th>
          <td colspan="2" style="text-align:center;"><b>Total Maintenance Budget</b></td>
          <td style="position: relative;">
            <b>
              <span style="position: absolute; left: 2;">IDR</span>
              <span style="position: absolute; right: 2;">{{number_format($dataSbe['items_sbe']['function_cost_plan_sbe'],2)}}</span>
