...
<head>
  ...
  <style type="text/css">
    ...
    .table-supply-only-header th{
      background-color: #ffc000;
      color: black;
    }

    .table-supply-only-body th{
      background-color: #ffc000;
      color: black;
    }

    .table-supply-only-body td:nth-child(1){
      text-align: center;
  ...
  <title>Project Budget Control - Supply Only Service</title>
</head>
<body>
  ...
  @foreach($data[0]['sbe'] as $key => $dataSbe)
    <table class="table-supply-only-header">
      <tr>
      ...
      <!-- loop items-->
    <table class="table-supply-only-body">
      @php
      ...
      @endforeach  
        ...
        <tr class="border">
          <th colspan="3"></th>
          <td colspan="2" style="text-align:center;"><b>Total Supply Only Budget</b></td>
          <td style="position: relative;">
            <b>
              <span style="position: absolute; left: 2;">IDR</span>
