		...
		<table width="100%" style="text-align:center;margin-bottom: 20px;">
			<tr>
				<td style="text-align:center;">
					PID: {{$data['claim']['pid_details'][0]['pid']}}				
				</td>
			</tr>
			<tr>
				<td style="text-align:center;">
					{{$data['claim']['pid_details'][0]['name_project']->name_project}}										
				</td>
			</tr>
		</table>
		<table style="width: 100%;">
			<tr>
				<td>
					{{ \Carbon\Carbon::parse($data['claim']['date'])->format('l, d F Y') }}
				</td>
			</tr>
		</table>
	...
	<table>
		...
		<tr>
			<td colspan="3" style="text-align:center;">
				<img src="{{$data['show_ttd'][0]['ttd']}}" width="75px" height="75px" style="padding: 10px;">
			</td>
			<td colspan="3" style="text-align:center;">
				@if(count($data['show_ttd']) > 1)
					<img src="{{$data['show_ttd'][1]['ttd']}}" width="75px" height="75px" style="padding: 10px;">
				@endif
			</td>
		</tr>
		<tr>
			<td colspan="3" style="text-align:center;font-family:Tahoma, Geneva,sans-serif;"><u>{{$data['show_ttd'][0]['name']}}</u></td>
			<td colspan="3" style="text-align:center;font-family:Tahoma, Geneva,sans-serif;">
				<u>
					@if(count($data['show_ttd']) > 1)
						{{$data['show_ttd'][1]['name']}}
					@endif
				</u>
			</td>
		</tr>
		<tr>
			...
			<th colspan="3" style="text-align:center;font-family:Tahoma, Geneva,sans-serif;">
				@if(count($data['show_ttd']) > 1)
