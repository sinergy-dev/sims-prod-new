...
<body style="display:block;width:900px;margin-left:auto;margin-right:auto;color: #000000">
	...
	@foreach($req_asset['asset'] as $data)		
		@if($data->status == 'ACCEPT')
			<b><i>Request Asset</i></b><h6><span class="span-success">ACCEPTED</span></h6>			
		@elseif($data->status == 'ON PROGRESS')
			<b><i>Request Asset</i></b><h6><span class="span-progress">ON PROGRESS</span></h6>	
			<p>New notes : {{$req_asset['notes']}}</p>
			<span>Detail notes asset dapat dilihat pada aplikasi!</span>		
		@elseif($data->status == 'PENDING')
			<b><i>Request Asset</i></b><h6><span class="span-pending">PENDING</span></h6>
		@else
			<b><i>Request Asset</i></b><h6><span class="span-reject">REJECTED</span></h6>
	@endif	
	...
	<h6 style="color: #f39c12 !important;margin-top: 0px" class="text-yellow" ><i>Application Development</i></h6>
	<p>
		----------------------------------------<br>
