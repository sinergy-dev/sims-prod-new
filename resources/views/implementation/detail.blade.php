                ...
                <div class="nav-tabs-custom active" id="project_tab" role="tabpanel" aria-labelledby="project-tab">
                    ...
                    <div class="tab-content">
                        @foreach($phase as $p_parent)
                            ...
                            @endif
                                    <center><h6><b><span style="background-color: green;color: white"> -- Progress -- </span></b></h6></center>
                                    ...
                                    <center><h6><b><span style="background-color: red;color: white"> -- Problem -- </span></b></h6></center>
        ...
        <div class="modal fade" id="problem_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                {!! csrf_field() !!}
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="exampleModalLongTitle">Engineer Problem (Edit)</h6>
                        </div>
                        <div class="modal-body">
