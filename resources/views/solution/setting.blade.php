	    ...
	    <section class="content">
	        <div class="box">
	            <div class="box-header">
	                <h6></h6>
	                <div class="box-tools">
	                    <button id="btnAddSetting" class="btn btn-sm text-bg-primary" style="margin-bottom: 10px;display: none;" onclick="addSetting()"><i class="icon-base bx bx-plus"></i>&nbsp Detail Item</button>
	                </div>
	            </div>
			            ...
			            <div class="col-md-4 pull-right" id="search-table">
			              <div class="input-group" style="margin-left: 10px">
			                <div class="input-group-btn">
			                  <button type="button" id="btnShowPID" class="btn btn-sm btn-default btn-flat dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
			                    Show 10 entries
			                  </button>
			                ...
			                <span class="input-group-btn">
			                  <button id="applyFilterTableSearch" type="button" class="btn btn-sm btn-default btn-md" style="width: 40px" onclick="searchCustom('tbListSetting','searchBarList')">
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-sm btn-default pull-left" data-dismiss="modal" fdprocessedid="u870yq">Close</button>
					<button type="button" class="btn btn-sm btn-primary" fdprocessedid="lkeg8g" id="saveSetting" onclick="saveDetailItems('create')">Save</button>
				</div>
			</div>
		</div>
	</div>
