        ...
        <div class="col-md-12">
          <div class="card mb-4">
            <div class="card-header with-border">
              <h6 class="card-title"><i class="bx bx-table"></i> Report Customer</h6>
            </div>   
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <button class="btn btn-sm btn-info reload-table"><i class="bx bx-refresh"></i> Refresh</button>
                  </div>
                </div> 
              </div>
                  ...
                  <ul class="nav nav-tabs" id="tabTerritory" style="display: none;">
                    @foreach($territory_loop as $data)
                     @if($data->id_territory == "TERRITORY 1")
                      <li class="nav-item">
                        <a class="nav-link active" id="{{ $data->code_ter }}" data-bs-toggle="tab" href="#{{ $data->code_ter }}" role="tab" aria-controls="{{ $data->code_ter }}" aria-selected="true" onclick="changeTerritory('{{$data->id_territory}}')">{{ $data->id_territory }}</a>
                      </li>
                     @else
                     <li class="nav-item">
                          <a class="nav-link" id="{{ $data->code_ter }}" data-bs-toggle="tab" href="#{{ $data->code_ter }}" role="tab" aria-controls="{{ $data->code_ter }}" aria-selected="true" onclick="changeTerritory('{{$data->id_territory}}')">{{ $data->id_territory }}</a>
                      </li>
                     @endif
                    @endforeach
                    <!--   <li class="nav-item">
                          <a class="nav-link" data-bs-toggle="tab" href="#msp" role="tab" aria-controls="msp" aria-selected="true" onclick="changeTerritory('msp')">MSP</a>
                      </li> -->
                      <li class="nav-item">
                          <a class="nav-link" id="ter_opp" data-bs-toggle="tab" href="#ter_opp" role="tab" aria-controls="ter_opp" aria-selected="true" onclick="changeTerritory('OPERATION')">OPERATION</a>
                      </li>
                  </ul>
                
                  <div class="tab-content">
                    <div class="tab-pane show active"  role="tabpanel" id="sip">
          ...
          <div class="card">
            <div class="card-header">
                <h6 class="card-title">Customer per Territory</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
...
@section('script')  
  <script type="text/javascript">
    ...
    function ApplyFilter(){
      territory = $(".nav-link.active").contents().text().trim();
      if(territory !== "ALL"){
        ...
        tableCustByTer.ajax.url("{{url('getCustomerPerTerritory')}}?id_territory=" + territory).load();
      } else{
