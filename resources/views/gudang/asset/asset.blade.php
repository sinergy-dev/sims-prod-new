                ...
                <tbody id="products-list" name="products-list">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @else
                      <button class="btn btn-sm btn-warning" onclick="pinjam('{{$data->id_barang}}','{{$data->nama}}','{{$data->qty}}')" data-target="#peminjaman" data-toggle="modal" >Peminjaman 
                      </button>
                      @endif
                    </td>
                    @if(Auth::User()->id_division == 'WAREHOUSE')
                    <td>
                      <a href="{{url('/detail_asset', $data->id_barang) }}"><button class="btn btn-sm" style="width: 150px;background-color: black;color: white ">Detail Peminjaman</button></a>
                    </td>
                    @endif
                  </tr>
                  @endforeach
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Asset Warehouse</h6>
        </div>
...
<div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Update Asset Warehouse</h6>
        </div>
        <div class="modal-body">
