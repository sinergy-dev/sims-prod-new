<div style="color: #555;font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
	...
	<table style="width: 400px;">
		<tr>
			<td style="width: 50px;">
				<h6 style="font-size: 24px;"><b><i>Trouble Ticket</i></b></h6>
			</td>
	...
	<table class="table table2" style="width: 400px;max-width: 100%;margin-bottom: 20px;border-spacing: 0;border-collapse: collapse;line-height: 1.42857143;vertical-align: top;">
		<tr >
			...
			<td style=" border:1px solid; padding: 3px;" class="holderID"></td>
		</tr>
		<tr>
			...
			<td style=" border:1px solid; padding: 3px;" class="holderRefrence"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCustomer"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderPIC"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderContact"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderProblem"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderLocation"></td>
		</tr>
		<tr style="display: none" class="holderIDATM2">
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderIDATM"></td>
		</tr>
		<!-- <tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderEngineer"></td>
		</tr> -->
		<tr>
		...
		<tr style="display: none" class="holderIPServer3">
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderIPServer4"></td>
		</tr>
		<tr>
		...
		<!-- <tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCounter"></td>
		</tr>
		<tr>
