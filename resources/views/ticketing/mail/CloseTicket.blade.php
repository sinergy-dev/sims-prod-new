<div style="color: #555;font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;">
	<p id="emailCloseHeader" style="margin: 0 0 10px;box-sizing: border-box;font-size: 14px;line-height: 1.42857143;color: #555;font-family: 'Source Sans Pro','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;">
		
	</p>
	<table style="width: 400px;">
		<tr>
			<td style="width: 50px;">
				<h6 style="font-size: 24px;"><b><i>Close Ticket</i></b></h6>
			</td>
	...
	<table class="table table2" style="width: 400px;max-width: 100%;margin-bottom: 20px;border-spacing: 0;border-collapse: collapse;line-height: 1.42857143;vertical-align: top;">
		<tr >
			...
			<td style=" border:1px solid; padding: 3px;" class="holderCloseID"></td>
		</tr>
		<tr>
			...
			<td style=" border:1px solid; padding: 3px;" class="holderCloseRefrence"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseCustomer"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderClosePIC"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseContact"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseProblem"></td>
		</tr>
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseLocation"></td>
		</tr>
		<tr style="display: none" class="holderCloseIDATM2">
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseIDATM"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td  style=" border:1px solid; padding: 3px;" class="holderCloseSerial"></td>
		</tr>
		<tr>
