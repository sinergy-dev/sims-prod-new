...
@section('content')
          ...
          <div class="nav-tabs-custom" id="asset" role="tabpanel">
            <ul class="nav nav-tabs" id="myTab" role="tablist"> 
              <li class="nav-item" style="display: none;">
                <a class="nav-link" id="list_asset" data-bs-toggle="tab" href="#asset_list" role="tab" aria-controls="current" aria-selected="false">List Asset</a>
              </li>
                <!-- <li class="nav-item">
                <a class="nav-link" id="kategori_list" style="display: none;" data-bs-toggle="tab" href="#kategori_asset" role="tab" aria-controls="kategori" aria-selected="false">Kategori</a>
              </li> -->
              <li class="nav-item">
                <a class="nav-link active" id="request_list" data-bs-toggle="tab" href="#request_asset" role="tab" aria-controls="asset" aria-selected="false">Request</a>
              </li>
                <!-- <button class="btn btn-sm btn-primary pull-right" style="display: none;width: 120px;margin-left: 5px;" id="addEvents"><i class="bx bx-plus"></i>&nbsp Calendar event</button>  --> 
                <!-- <a href="{{action('AssetHRController@export')}}" id="btnExport" class="btn btn-sm btn-info btn-sm pull-right" style="margin-right: 5px;display: none;"><i class="bx bx-cloud-download"></i>&nbsp&nbspExport</a> -->
                <!-- <div class="card-body">
                  <form action="{{ url('import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="file" name="file" class="form-control">
                    <br>
                    <button class="btn btn-sm btn-warning btn-sm pull-right">Import Data</button>
                  </form>
                </div> -->
                <li class="nav-item" style="display: none;">
                  <a class="nav-link" id="occ_asset" data-bs-toggle="tab" href="#current_asset" role="tab" aria-controls="occurance" aria-selected="false"> Occurance</a>
                </li>          
              <li class="nav-item">
                <a class="nav-link" id="history_asset" data-bs-toggle="tab" href="#history" role="tab" aria-controls="history" aria-selected="false">History</a>
              </li>
              <div class="form-group btn-action-asset ms-auto">
                <!-- <button class="btn btn-sm btn-success" data-bs-toggle="modal" id="btnAdd" style="display: none;"><i class="bx bx-plus"> </i>&nbsp Asset</button> -->
             <!--    <button onclick="exportExcel()" id="btnExport" class="btn btn-sm btn-info btn-sm" style="margin-right: 5px;display: none;"><i class="bx bx-cloud-download"></i>&nbsp&nbspExport</button>
                <button id="btnImport" onclick="importData()" class="btn btn-sm btn-warning btn-sm" style="margin-right: 5px;"><i class="bx bx-cloud-upload"></i>&nbsp&nbspImport</button> -->
                <button class="btn btn-sm btn-success" style="width: 150px;margin-right: 5px;display: none;" id="btnRequest">Request Asset</button>
                <button class="btn btn-sm btn-info" style="width: 150px;margin-right: 5px;display: none!important;" id="btnPinjam">Borrow Asset</button>
              </div>
            </ul>
            <div class="tab-content" id="myTabContent">           
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                ...
                                @if($data->date_of_entrys > 365)
                                  <label class="badge text-bg-info"><litle>Masa kerja : {{floor($data->date_of_entrys / 365)}} Tahun {{floor($data->date_of_entrys % 365 / 30)}} Bulan </litle></label>
                                  <label class="badge text-bg-warning" style="margin-left: 5px;"><litle>Status karyawan : {{$data->status_kerja}}</litle></label>
                                @elseif($data->date_of_entrys > 31)
                                  <label class="badge text-bg-info"><litle>Masa kerja : {{floor($data->date_of_entrys / 30)}} Bulan</litle></label>
                                  <label class="badge text-bg-warning" style="margin-left: 5px;"><litle>Status karyawan : {{$data->status_kerja}}</litle></label>
                                @else
                                  <label class="badge text-bg-info"><litle>Masa kerja : {{floor($data->date_of_entrys)}} Hari </litle></label>
                                  <label class="badge text-bg-warning" style="margin-left: 5px;"><litle>Status karyawan : {{$data->status_kerja}}</litle></label>
                                @endif
                            </td>
                            <td width="5%">
                            ...
                            <td width="5%">                      
                              @if($data->status == "UNAVAILABLE")
                              <button class="btn btn-sm btn-xs btn-secondary btn-pengembalian" value="{{$data->id_barang}}" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Pengembalian" data-placement="bottom"><i class="bx bx-history"></i></button>
                              <button class="btn btn-sm btn-xs btn-warning barang_asset_edit" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" value="{{$data->id_barang}}"><i class="bx bx-edit" data-bs-toggle="tooltip" title="Edit Asset" data-placement="bottom"></i></button>
                              <button class="btn btn-sm btn-xs btn-danger btn-hapus" disabled style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Hapus" data-placement="bottom"><i class="bx bx-trash-o"></i></button>
                              @elseif($data->status == "AVAILABLE")                      
                              <button class="btn btn-sm btn-xs btn-success btn-peminjaman" onclick="pinjam('{{$data->id_barang}}','{{$data->nama_barang}}')" data-bs-toggle="tooltip" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" title="Peminjaman" data-placement="bottom"><i class="bx bx-history"></i></button>
                              <button class="btn btn-sm btn-xs btn-warning barang_asset_edit" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" id="barang_asset_edit" value="{{$data->id_barang}}"><i class="bx bx-edit" data-bs-toggle="tooltip" title="Edit Asset" data-placement="bottom"></i></button>
                              <button class="btn btn-sm btn-xs btn-danger btn-hapus" onclick="hapus('{{$data->id_barang}}','{{$data->nama_barang}}')" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Hapus" data-placement="bottom"><i class="bx bx-trash-o"></i></button>
                              @elseif($data->status == "PENDING" || $data->status == "RUSAK" || $data->status == "SERVICE")
                              <button class="btn btn-sm btn-xs btn-secondary" disabled style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Pengembalian" data-placement="bottom"><i class="bx bx-history"></i></button>
                              <button class="btn btn-sm btn-xs btn-warning" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" disabled><i class="bx bx-edit" data-bs-toggle="tooltip" title="Edit Asset" data-placement="bottom"></i></button>
                              <button class="btn btn-sm btn-xs btn-danger btn-hapus" disabled style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Hapus" data-placement="bottom"><i class="bx bx-trash-o"></i></button>
                              @else
                              <button class="btn btn-sm btn-xs btn-secondary" disabled  style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Pengembalian" data-placement="bottom"><i class="bx bx-history"></i></button>
                              <button class="btn btn-sm btn-xs btn-warning" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" disabled><i class="bx bx-edit" data-bs-toggle="tooltip" title="Edit Asset" data-placement="bottom"></i></button>
                              <button class="btn btn-sm btn-xs btn-danger btn-hapus" disabled style="width:35px;height:30px;border-radius: 25px!important;outline: none;" data-bs-toggle="tooltip" title="Hapus" data-placement="bottom"><i class="bx bx-trash-o"></i></button>
                              @endif                      
                              <a href="{{url('/detail_peminjaman_hr', $data->id_barang) }}"><button class="btn btn-sm btn-xs btn-primary" style="width:35px;height:30px;border-radius: 25px!important;outline: none;"><i class="bx bx-info" aria-hidden="true" data-bs-toggle="tooltip" title="History" data-placement="bottom"></i></button></a>
                            </td>
                        ...
                        <tbody id="products-list" name="products-list">
                          ...
                          @foreach($kategori_asset as $data)
                            <tr>
                              ...
                              <td>{{$data->qty_kat}}</td>
                              <td>
                                <button class="btn btn-sm btn-xs btn-warning" onclick="editKategori('{{$data->code_kat}}','{{$data->kategori}}','{{$data->id}}','edit')" data-bs-toggle="tooltip" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" title="Update" data-placement="bottom"><i class="bx bx-edit"></i></button>
                              </td>
                            </tr>
                          @endforeach
                        </tbody>
              ...
              <div class="tab-pane show active" id="request_asset">
                <div class="table-responsive">
                        ...
                        <tr>
                          ...
                          <td>
                            @if(str_contains($datas->link, 'https://'))
                              <span class="badge text-bg-info copy-icon" onclick="copyLinkUrl('{{$datas->link}}')">Salin</span><span class="link_data" style="cursor:pointer" data-bs-toggle="tooltip" data-placement="right" title="{{$datas->link}}">{{str_limit($datas->link,25)}}</span>
                            @else
                              <span class="link_data" style="cursor:pointer" data-bs-toggle="tooltip" data-placement="right" title="{{$datas->link}}">{{str_limit($datas->link,25)}}</span>
                            @endif
                          </td>  
                          ...
                          <td width="5%">
                            ...
                            <label class="badge text-bg-info">{{$datas->status}}</label>
                            @else
                            <label class="badge text-bg-warning">{{$datas->status}}</label>
                            @endif
                          </td>
                          <td>
                    ...
                    <tbody id="products-list" name="products-list">
                      ...
                      @foreach($pinjam_request as $data)
                        <tr>
                          ...
                          <td width="40%"> - </td> 
                          <td width="5%"><label class="badge text-bg-warning">PENDING</label></td>                     
                          <td width="5%">
                            <button class="btn btn-sm btn-xs btn-info" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" onclick="btnEditRequestAsset('{{$data->id_transaction}}','pinjam')"><i class="bx bx-edit" style="color: white" aria-hidden="true"></i></button>
                          </td>
                        </tr>
                      @endforeach
                      @foreach($current_request as $datas)
                        <tr>
                          ...
                          <td width="5%">
                            <button class="btn btn-sm btn-xs btn-info" style="width:35px;height:30px;border-radius: 25px!important;outline: none;" onclick="btnEditRequestAsset('{{$datas->id_request}}','request')"><i class="bx bx-edit" style="color: white" aria-hidden="true"></i></button>
                          </td>
                        </tr>
                      @endforeach
                      @foreach($current_borrowed as $data)
                        <tr>
                          ...
                          <td  width="5%"><label class="badge text-bg-success">BORROWING</label></td>                     
                          <td  width="5%">
                            <button class="btn btn-sm btn-xs" style="width:35px;height:30px;border-radius: 25px!important;outline: none;background-color: black" id="btn_info_asset_transac" value="{{$data->id_transaction}}"><i class="bx bx-info" style="color: white" aria-hidden="true"></i></button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
                    ...
                    <tbody id="products-list" name="products-list">
                      ...
                      @foreach($history_request as $datas)
                        <tr>
                          ...
                          <td>{{$datas->reason}}</td>   
                          @if($datas->link_drive != null || $datas->link_drive != "")
                            <td><a href="{{$datas->link_drive}}" target="_blank"><i class="bx bx-file-image-o"></i> files</a></td>                 
                          @else
                            <td> - </td>                   
                          @endif                                                                     
                          <td width="5%">
                            @if($datas->status == 'ACCEPT')
                            <label class="badge text-bg-success">ACCEPTED</label>
                            @elseif($datas->status == 'REJECT')
                            <label class="badge text-bg-danger">REJECTED</label>
                            @else
                            <label class="badge text-bg-warning">{{$datas->status}}</label>
                            @endif
                          </td>
                          <td>
                            <button class="btn btn-sm btn-primary btn-sm"  onclick="requestAssetAccept('{{$datas->id_request}}','DETAIL')">Detail</button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">        
            <div class="modal-header">
              <h6 class="modal-title">Add Asset HR/GA</h6>
            </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="col-md-6 form-group">
                        ...
                        <input name="asset_code" id="asset_code" class="d-block form-control" value="{{$nomor}}" disabled>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="col-md-6 form-group" style="display: none;" id="peminjams">
                        ...
                        <input type="text" name="requestBy" id="requestBy" class="form-control" disabled="">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-sm btn-success" id="btnSubmit"><i class="bx bx-check"></i>&nbsp Submit</button>
            </div>
          <!-- </form> -->
        </div>
      </div>
  ...
  <div class="modal fade" id="modalCalender">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Events Calender</h6>
        </div>
        <div class="modal-body">
          <div class="form-group">
            <label>Date & Time</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspClose</button>
            <button type="button" class="btn btn-sm btn-info" id="submitCalendar"><i class="bx bx-check"></i>&nbsp Submit</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="modaledit" role="dialog">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">Update Asset HR/GA</h6>
          </div>
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="sow">Name</label>
              <input class="form-control" type="text" name="nama_barang_asset_edit" id="nama_barang_asset_edit" disabled placeholder="asset name">
            </div>
            ...
            <div class="form-group">
              <label for="sow">Serial Number</label>
              <input class="form-control" type="text" name="asset_sn_edit" id="asset_sn_edit" disabled placeholder="serial number">
            </div>
  ...
  <div class="modal fade" id="peminjaman" role="dialog">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">Request Asset</h6>
          </div>
          <div class="modal-body">
  ...
  <div class="modal fade" id="requestAsset" role="dialog">
      <div class="modal-dialog modal-xl" style="width:950px">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">Request Asset</h6>           
          </div>
 ...
 -->
                ...
                <div style="margin-bottom: 20px;" class="divItem">
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Category</label>
                        <input id="cat_req_id" data-rowid="0" hidden><select class="form-control category_asset_request" name="items[0][category_asset_request]" data-rowid="0" required style="width:100%!important"></select>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <label>Merk</label>
                    ...
                    <div class="col-md-3">
                      <label>Used for</label>
                      <select name="items[0][keperluan_barang_request]" class="form-control keperluan_barang_request" required style="width:100%!important" data-rowid="0"><option></option></select>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-3">
  ...
  <div class="modal fade" id="requestAssetEdit" role="dialog">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">Detail Request Asset</h6>           
          </div>
          <div class="modal-body">
            @csrf
            <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspClose</button>
                <button type="button" class="btn btn-sm btn-info" id="btnAddNoteReq"><i class="bx bx-check"></i>&nbsp Submit</button>
                <button type="button" class="btn btn-sm btn-danger" id="btnBatalReq"><i class="bx bx-trash"></i>&nbsp Batalkan</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="modal fade" id="importAsset" role="dialog">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h6 class="modal-title">Import Asset</h6>           
          </div>
          <div class="modal-body">
            ...
            <div class="modal-footer">
                <button class="btn btn-sm btn-warning btn-sm">Import Data</button>
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspClose</button>
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{url('penghapusan_hr')}}" name="modalProgress">
              ...
              <input name="nama_barang" id="nama_barang_hapus" class="form-control" disabled></input>
            </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspClose</button>
                <button type="submit" class="btn btn-sm btn-danger"><i class="bx bx-check"></i>&nbsp Hapus</button>
              </div>
          </form>
          </div>
        </div>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="form-group">
            	<h6 style="text-align: center;"><b>ACCEPT NOW!</b></h6>
            </div>
            <div class="form-group modalIconsubject inputIconBg" style="padding-left: 10px">
<<<<<<< HEAD
              <input type="text" class="form-control money" name="no_peminjaman" id="no_peminjaman" disabled>
              <i class="" aria-hidden="true">No Peminjaman &nbsp</i>
            </div>
            <div class="form-group modalIconsubject inputIconBg" style="padding-left: 10px">
              <input type="text" class="form-control money" name="nama_peminjam" id="nama_peminjam" disabled>
=======
...
>>>>>>> 2630783529c42e098fe1f3f8590633739c0abd79
            ...
            <div class="modal-footer">
<<<<<<< HEAD
              <button type="button" class="btn btn-sm btn-secondary btn-sm" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspCANCEL</button>
              <button type="submit" class="btn btn-sm btn-success btn-sm"><i class="bx bx-check"></i>&nbsp YES</button>
=======
              <button type="button" class="btn btn-sm btn-default btn-sm" data-dismiss="modal"><i class="fa fa-times"></i>&nbspCANCEL</button>
              <button type="submit" class="btn btn-sm btn-success btn-sm"><i class="fa fa-check"></i>&nbsp YES</button>
>>>>>>> 2630783529c42e098fe1f3f8590633739c0abd79
            </div>
          </form>
          </div>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="form-group">
            	<h6 style="text-align: center;"><b>REJECT NOW!</b></h6>
            </div>
            <div class="form-group modalIconsubject inputIconBg" style="padding-left: 10px">
<<<<<<< HEAD
              <input type="text" class="form-control money" name="no_peminjaman" id="no_peminjaman2" disabled>
              <i class="" aria-hidden="true">No Peminjaman &nbsp</i>
            </div>
            <div class="form-group modalIconsubject inputIconBg" style="padding-left: 10px">
              <input type="text" class="form-control money" name="nama_peminjam" id="nama_peminjam2" disabled>
=======
...
<<<<<<< HEAD
              <button type="button" class="btn btn-sm btn-secondary btn-sm" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspCANCEL</button>
              <button type="submit" class="btn btn-sm btn-danger btn-sm"><i class="bx bx-check"></i>&nbsp YES</button>
=======
              <button type="button" class="btn btn-sm btn-default btn-sm" data-dismiss="modal"><i class="fa fa-times"></i>&nbspCANCEL</button>
              <button type="submit" class="btn btn-sm btn-danger btn-sm"><i class="fa fa-check"></i>&nbsp YES</button>
>>>>>>> 2630783529c42e098fe1f3f8590633739c0abd79
            </div>
          </form>
          </div>
      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="form-group">
              <h6 style="text-align: center;">Return Asset</h6>
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td>
                    <input type="date" name="tanggal_kembali" id="tanggal_kembali" disabled class="form-control">
                  </td>
                  <td>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-sm btn-secondary btn-sm" data-bs-dismiss="modal"><i class="bx bx-x"></i>&nbspCANCEL</button>
                <button type="submit" class="btn btn-sm btn-success btn-sm"><i class="bx bx-check"></i>&nbsp Submit</button>
              </div>
          </form>
          </div>
        </div>
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="info_all">
    <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Detail Information</h6>
        </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h6 class="modal-title">Asset Request Detail</h6>
        </div>
        <div class="modal-body" id="">
          ...
          <div class="card-container" style="max-height: 400px;display:none;">
            <div class="card-footer card-comments" style="overflow-y: scroll;max-height: 400px;">
            </div>
          </div> 
        ...
        <div class="modal-footer">
        	<button type="button" id="btnAcceptRequest" class="btn btn-sm btn-primary" style="display:none;">Submit</button>
          <button type="button" id="btnRejectRequest" class="btn btn-sm btn-danger" style="display:none;">Reject</button>
          <button type="button" id="btnResolveRequest" class="btn btn-sm btn-success" style="display:none;">Approve</button>
          <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
...
@section('scriptImport')
  ...
  <script type="text/javascript" src="{{asset('assets/js/roman.js')}}"></script>
...
@section('script')  
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        //buat btn btn-sm add asset di disable dulu
        ...
        //     //   $("#btnAdd").show();
        //     //   $("#btnExport").show();
        //     //   $("#btnAdd").html('<i class="bx bx-plus"></i> &nbspAsset');
        //     //   $("#btnAdd").attr('data-target','#add_asset');
        //     //   $("#btnAdd").removeAttr('onclick');
        //     //   $("#btnAdd").attr('data-bs-toggle','modal');
        //     //   $("#company_asset").val("")
        //     //   $("#nama_barang").val("")
        //     //   $("#asset_sn").val("")
        //     //   $("#keterangan").val("")
        ...
        //     //   $("#btnExport").show();
        //     //   $("#btnAdd").html('<i class="bx bx-plus"></i> &nbspKategori');
    ...
    $(document).on('change',".category_asset_request",function(e) { 
    ...
    $("#btnAddRowReq").click(function(){     
      ...
      // append = append + '</td> '
      // append =  append + '<td><button class="btn btn-sm btn-xs btn-danger remove" data-rowid="'+i+'" type="button" data-bs-toggle="tooltip" style="width:35px;height:30px;border-radius: 25px!important;outline: none;float: right;" ><i class="bx bx-trash-o"></i></button>'
      // append =  append + '</td>'
      // append =  append + '</tr>'
        ...
        append = append + '<div class="row">'
          ...
          append = append + '<div class="col-md-3">'
            append = append + '<div class="form-group">'
              ...
              append = append + '<input id="cat_req_id" data-rowid="'+ i +'" hidden><select class="form-control category_asset_request" name="items['+ i +'][category_asset_request]" data-rowid="'+ i +'" required style="width:100%!important"></select>'
              append = append + '</div>'
          append = append + '</div>'
          append = append + '<div class="col-md-3">'
          ...
          append = append + '<div class="col-md-3">'
            ...
            append = append + '<select name="items['+ i +'][keperluan_barang_request]" class="form-control keperluan_barang_request" required style="width:100%!important" data-rowid="'+ i +'"><option></option></select>'
          append = append + '</div>'
        append = append + '</div>'
        append = append + '<div class="row">'
          append = append + '<div class="col-md-3">'
    ...
    $(document).on('click',"#btn_info_asset",function(e) { 
      ...
      $.ajax({
          ...
          success: function(result){
            append = append + '<h6>Detail Asset <b>' + result[0].nama_barang + '</b></h6>'
    ...
    $(document).on('click',"#btn_info_asset_transac",function(e) { 
      ...
      $.ajax({
          ...
          success: function(result){
            append = append + '<h6>Transaction <b>' + result[0].no_transac + '</b></h6>'
            append = append + '<table style="width:100%;border-collapse:collapse">'
            append = append + '<tr>' 
    ...
    $(".btn-comment-accept-request").click(function(){
      $.ajax({
        ...
        success:function(result){
          Swal.close()
          var inc = $(".card-comments").find(".card-comment").length + 1
    ...
    function deleteComment(id){
      $(".card-comment[data-rowid='"+ id +"']").remove()
    }
  </script>
@endsection