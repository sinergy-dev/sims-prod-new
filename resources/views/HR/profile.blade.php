...
<style type="text/css">
   ...
   /*   background: #3333ff;*/
    ...
    input[type=number]:focus{
      ...
      card-shadow:0 0 8px 0 dodgerBlue;
    }
   ...
   .profileInput i{
    ...
    /* The message card is shown when the user clicks on the password field */
    #message {
      display:none;
      background: #f1f1f1;
      color: #000;
          ...
          <div class="card-body card-profile">
            ...
            <div class="mt-4">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  <i class="bx bx-phone">&nbsp</i><b class="">Phone</b> <b class="pull-right">+62{{$user_profile->phone}}</b>
                </li>
              </ul>
            </div>
            <!-- <div class="row mb-4" style="padding-left:25px">
              <button class="btn btn-sm btn-primary btn-edit" type="button" style="width: 150px"><i class="bx bx-key"></i> Change Password</button>
              <a href="{{url('show_cuti')}}" style="margin-left: 10px"><button class="btn btn-sm btn-success" style="width: 150px"><i class="bx bx-user"></i> Leaving Permite</button></a>
            </div> -->
            <div class="d-grid gap-2 mt-4">
              <a class="btn btn-sm text-bg-primary btn-edit" type="button"><b>Change Password</b></a>
              <a href="{{url('show_cuti')}}" class="btn btn-sm btn-success" type="button"><b>Leaving Permit</b></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="tab" href="#attachfile">Attach File</a>
                </li>
              </ul>
              <div class="tab-content">
                ...
                <div class="tab-pane show active" id="profile">
                  <div class="post">
                    <h6 style="padding-left: 10px"><b>User Profile</b></h6>
                    ...
                    <form class="form-horizontal" action="{{url('update_profile')}}" enctype="multipart/form-data" method="POST">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <input type="email" class="form-control" id="email" name="email" placeholder="Type Email" value="{{$user_profile->email}}" disabled>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control pull-right" id="date_of_entry" name="date_of_entry" value="{{date('d/m/Y',strtotime($user_profile->date_of_entry))}}" disabled>
                            </div>
                          </div>
                      ...
                      <div class="card-footer">
                        <button type="submit" class="btn btn-sm btn-primary pull-right"><i class="bx bx-edit"></i> Update</button>
                      </div>
                    </form>
                  </div>
                </div>
                ...
                <div class="tab-pane" id="attachfile">
                  <div class="tab-content">
                    <h6 style="padding-left: 10px"><b>Attach File</b></h6>
                    <br>
                    <form action="{{url('update_profile_npwp')}}" enctype="multipart/form-data" method="POST">
                      ...
                      @csrf
                          ...
                          <div class="col-md-4">
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              ...
                              <div class="card-body">
                                ...
                                <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarnpwp" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @else
                                  <img class="entry" src="{{url('image') . "/" . $user_profile->npwp_file}}" id="showgambarnpwp" style="max-width: 150px;max-height: 150px;border-radius:5px;margin:0px auto;display:block"/>
                                @endif
                              </div>
                              <div class="card-footer">
                            ...
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              ...
                              <div class="card-body">
                                @if($user_profile->ktp_file == "-" || $user_profile->ktp_file == null || $user_profile->ktp_file == "")
                                  <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarktp" style="max-width: 150px;max-height: 150px; align-items: center;"/>
                                @else
                                  <img class="entry" src="{{url('image') . "/" . $user_profile->ktp_file}}" id="showgambarktp"  style="max-width: 150px;max-height: 150px;border-radius:5px;margin:0px auto;display:block"/>
                                @endif
                              </div>
                              <div class="card-footer">
                          ...
                          <div class="col-md-4">
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              <div class="card-header">
                                <h6 class="card-title">BPJS Ketenagakerjaan File</h6>
                              </div>
                              <div class="card-body">
                                @if($user_profile->bpjs_ket_file == "-" || $user_profile->bpjs_ket_file == "" || $user_profile->bpjs_ket_file == null)
                                  <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarbpjs_ket" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @else
                                  <img class="entry" src="{{url('image') . "/" . $user_profile->bpjs_ket_file}}" id="showgambarbpjs_ket" style="max-width: 150px;max-height: 150px;float: left;border-radius:5px"/>
                                @endif
                              </div>
                              <div class="card-footer" >
                        ...
                        <div class="row mb-4">
                          <div class="col-md-4">
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              <div class="card-header">
                                <h6 class="card-title">BPJS Kesehatan File</h6>
                              </div>
                              <div class="card-body">
                                @if($user_profile->bpjs_kes_file == "-" || $user_profile->bpjs_kes_file == "" || $user_profile->bpjs_kes_file == null)
                                  <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarbpjs_kes" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @else
                                  <img class="entry" src="{{url('image') . "/" . $user_profile->bpjs_kes_file}}" id="showgambarbpjs_kes" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @endif
                              </div>
                              <div class="card-footer">
                          ...
                          <!-- <div class="col-md-4">
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              <div class="card-header">
                                <h6 class="card-title">Sign File</h6>
                              </div>
                              <div class="card-body">
                                @if($user_profile->ttd_digital == null)
                                  <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarsign" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @else
                                  <img class="entry" src="{{url($user_profile->ttd_digital)}}" id="showgambarsign" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @endif
                              </div>
                              <div class="card-footer">
                            ...
                            <div class="card card-primary" style="background-color: #F7F7F7;">
                              ...
                              <div class="card-body">
                                @if($user_profile->ttd == null)
                                  <img class="entry" src="{{url('img/img_nf.png')}}" id="showgambarsign" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @else
                                  <img class="entry" src="{{url($user_profile->ttd)}}" id="showgambarsign" style="max-width: 150px;max-height: 150px;float: left;"/>
                                @endif
                              </div>
                              <div class="card-footer">
                                  <input type="file" id="inputSign" name="inputSign">
                      ...
                      <div class="card-body">
                                ...
                                <!-- <div class="form-group row">
                                  <div class="col-md-6">
                                    <button class="btn btn-sm btn-primary pull-right" type="submit"><i class="bx bx-edit"></i>&nbspUpdate</button>
                                    <button type="submit" class="btn btn-sm btn-primary pull-right"><i class="bx bx-edit"></i> Update</button>
                                  </div>
                                </div> -->
                      </div>
