      ...
      <div class="card-body">
        <div class="nav-tabs-custom active" id="asset" role="tabpanel">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link home-tab" id="home-tab" data-bs-toggle="tab" style="display: none;" href="#peminjaman_asset_atk" role="tab" aria-controls="home" aria-selected="true">Request ATK - Facilities</a>
            </li>
            <li class="nav-item">
              <a class="nav-link home-tab-2" id="home-tab-2" data-bs-toggle="tab" style="display: none;" href="#peminjaman_asset_atk_2" role="tab" aria-controls="home" aria-selected="true">Request ATK - Requestor</a>
            </li>
            ...
            @endif -->
            <div class="form-group ms-auto pull-right" style="float: right;">
              ...
              <div class="dropdown">
                <button class="btn btn-sm btn-success request_atk" id="request_atk" style="display: none!important;"><i class="bx bx-plus"> </i>&nbspRequest ATK</button>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($data->status == 'PENDING')
                          <label class="badge text-bg-warning" style="width: 90px">PENDING</label>
                        @elseif($data->status == 'ACCEPT')
                          <label class="badge text-bg-primary" style="width: 90px">ACCEPTED</label>
                        @elseif($data->status == 'REJECT')
                          <button class=" btn text-bg-danger" data-bs-target="#reject_note_modal" data-bs-toggle="modal" style="width: 90px; color: white;" onclick="reject_note('{{$data->id_transaction}}', '{{$data->note}}')"> REJECTED</button>
                        @elseif($data->status == 'PROSES')
                          <label class="badge text-bg-secondary" style="width: 90px">PROSES PR</label>
                        @elseif($data->status == 'DONE')
                          <label class="badge text-bg-success" style="width: 90px">DONE</label>
                        @endif
                      </td>
                      <td>
                        @if($data->status == 'PENDING')
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @elseif($data->status == 'ACCEPT')
                            <label class="badge text-bg-primary" style="width: 90px">ACCEPTED</label>
                          @elseif($data->status == 'REJECT')
                            <button class=" btn btn-danger" data-bs-target="#reject_note_modal" data-bs-toggle="modal" style="width: 90px; color: white;" > REJECTED</button>
                          @endif
                        </td>
                        <td>
                          @if($data->status == 'REQUEST')
                            @if($data->qty_asset != '0')
                              <button class="btn btn-sm btn-success" id="btn_accept_request_atk" value="{{$data->id_barang}}" name="btn_accept" style="width: 90px; height: 25px;">ACCEPT</button>
                              <button class="btn btn-sm btn-danger" id="btn_reject" name="btn_reject" style="width: 90px; height: 25px;" onclick="reject_request_atk('{{$data->id_barang}}')">REJECT</button>
                            @else 
                              <button class="btn btn-sm btn-success disabled" style="width: 90px; height: 25px;">ACCEPT</button>
                              <button class="btn btn-sm btn-danger" id="btn_reject" name="btn_reject" style="width: 90px; height: 25px;" onclick="reject_request_atk('{{$data->id_barang}}')">REJECT</button>
                            @endif
                          ...
                          <button class="btn btn-sm btn-primary" id="btn-done" data-bs-target="#done_request_modal" data-bs-toggle="modal" name="btn_done" style="width: 90px; height: 25px" onclick="done_request_atk('{{$data->id_barang}}', '{{$data->nama}}', '{{$data->qty}}', '{{$data->nik}}', '{{$data->keterangan}}')">DONE</button>
                          @elseif($data->status == 'DONE')
                    ...
                    @foreach($request2 as $data)
                      ...
                      <td>
                        @if($data->status == 'REQUEST' || $data->status == 'PROCESS')
                          <label class="badge text-bg-warning" style="width: 90px">PENDING</label>
                        @elseif($data->status == 'DONE')
                          <label class="badge text-bg-primary">DONE</label>
                        @elseif($data->status == 'REJECT')
                          <button class=" btn btn-sm btn-danger" data-bs-target="#reject_note_modal" data-bs-toggle="modal" style="width: 90px; color: white;" onclick="reject_note('{{$data->id_transaction}}', '{{$data->note}}')"> REJECTED</button>
                        @endif
                      </td>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Asset ATK</h6>
        </div>
...
<div class="modal fade" id="modalrestock" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Update Stok ATK</h6>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="peminjaman_modal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Request ATK</h6>
        </div>
        <div class="modal-body">
