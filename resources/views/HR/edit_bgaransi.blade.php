        ...
        <div class="row">
          <div class="col-sm-7">
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input class="custom-form-control-select w-100" name="kode_proyek" id="kode_proyek" type="text" placeholder="Enter Kode Proyek" value="{{$datas->kode_proyek}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <textarea class="custom-form-control-select w-100" name="nama_proyek" id="nama_proyek" type="text" placeholder="Enter Nama Proyek">{{$datas->nama_proyek}}</textarea>
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="text" name="no" id="no" class="custom-form-control-select w-100" placeholder="Enter No Proyek" value="{{$datas->no_proyek}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="text" name="perusahaan" id="perusahaan" class="custom-form-control-select w-100" placeholder="Enter Perusahaan" value="{{$datas->perusahaan}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="text" name="div" id="div" class="custom-form-control-select w-100" placeholder="Enter Division" value="{{$datas->division}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-10">
                <input type="number" class="custom-form-control-select w-100" placeholder="Enter No Telp" name="no_telp" id="no_telp" value="{{$datas->telp}}">
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-5">
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input class="custom-form-control-select w-100" id="today" type="date" readonly>
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input type="number" class="custom-form-control-select w-100" placeholder="Enter No Fax" name="no_fax" id="no_fax" value="{{$datas->fax}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <textarea class="custom-form-control-select w-100" placeholder="Enter Alamat" name="alamat" id="alamat">{{$datas->alamat}}</textarea>
              </div>
            </div>
            ...
            <!-- <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input class="custom-form-control-select w-100" name="kota" id="kota" placeholder="Enter Kota">
              </div>
            </div> -->
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <input type="text" class="custom-form-control-select w-100" placeholder="Enter Kode Pos" name="kode" id="kode" value="{{$datas->kode_pos}}">
              </div>
            </div>
            ...
            <div class="form-group row" style="margin-left: -12px">
              ...
              <div class="col-sm-8">
                <textarea class="custom-form-control-select w-100" placeholder="Enter Note" name="note" id="note">{{$datas->note}}</textarea>
              </div>
            </div>
        ...
        <table id="product-add" class="table">
            ...
            <tr>
              <td style="margin-bottom: 50px">
                ...
                <select class="custom-custom-form-control-select w-100-select w-100" name="jenis" id="jenis">
              ...
              <td style="margin-bottom: 50px;">
                ...
                <select class="custom-custom-form-control-select w-100-select w-100" name="penerbit" id="penerbit">
              ...
              <td style="margin-bottom: 50px">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="custom-form-control-select w-100 pull-right" name="tgl_mulai" id="tgl_mulai" value="{{$datas->tgl_mulai}}">
                </div>
                <!-- <input class="custom-form-control-select w-100" type="date" name="tgl_mulai" value="{{$datas->tgl_mulai}}"> -->
              </td>
            </tr>
            <tr class="tr-header">
            ...
            <tr>
              <td style="margin-bottom: 50px">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="custom-form-control-select w-100 pull-right" name="tgl_selesai" id="tgl_selesai" value="{{$datas->tgl_selesai}}">
                </div>
                <!-- <input class="custom-form-control-select w-100" type="date" name="tgl_selesai" value="{{$datas->tgl_selesai}}"> -->
              </td>
              <td style="margin-bottom: 50px">
                <br>
                <div class="modalIconn inputIconBg" style="padding-left: 10px">
                  <input type="text" class="custom-form-control-select w-100" name="jangka" id="jangka" value="{{$datas->jangka_waktu}}">
              ...
              <td style="margin-bottom: 50px">
                ...
                <select class="custom-form-control-select w-100" name="dokumen" id="dokumen">
            ...
            <tr>
              <td style="margin-bottom: 50px">
                <br><input type="text" class="custom-form-control-select w-100" placeholder="Enter No Dok" name="no_dok" id="no_dok" value="{{$datas->no_dok}}">
              </td>
              <td style="margin-bottom: 50px">
                <br>
                @if($datas->valuta == 'USD')
              ...
              <td style="margin-bottom: 50px">
                ...
                <input type="text" class="custom-form-control-select w-100 money" placeholder="Enter Amount" name="nominal" id="nominal" value="{{$datas->nominal}}">
