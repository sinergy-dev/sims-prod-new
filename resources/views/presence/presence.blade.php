			...
			<div class="card p-3">
				...
				<center>
					<div class="row mt-4">
						...
						@else
							<h6>Thank you for your hard work today</h6>
						@endif
						</div>
					</div>
				</center>
				...
				<div style="padding: 10px;">
					<span style="flex-grow: 1;margin-right: 5px;"><i class="bx bx-desktop"></i></span><span style="flex-grow: 2;">Accessed : </span><span id="current_time">{{ now()->timezone('Asia/Jakarta')->format('l, d M Y H:i:s') }}</span><br>
					<span style="flex-grow: 1;margin-right: 5px;"><i class="bx bx-map-pin"></i></span><span>Current Location : </span><span id="current_location"></span>
				</div>
			</div> 
		</section>
	</div>
