...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3 col-xs-12" id="box-filter" style="display:none">
          <div class="card card-primary">
            ...
            <div class="card-footer">
              <div class="d-grid gap-2">
                <button class="btn btn-sm btn-primary" onclick="filterAsset()">Filter</button>
                <button class="btn btn-sm btn-danger" onclick="filterResetAsset()">Reset Filter</button>
              </div>
            </div>
          </div>
        </div>

        <div class="col-md-9 col-xs-12" id="box-table-asset">
          <div class="card card-primary">
            <div class="card-header">
              <div class="row mb-2">
                <div class="col-md-12">
                  ...
                  <button class="btn btn-sm btn-warning btnAssignEngineer" id="btnAssignEngineer" onclick="btnAssignEngineer()" style="display: none!important;"><i class="bx bx-cog"></i> Assign Engineer</button>
                  <button class="btn btn-sm btn-info btnGenerateQR" id="btnGenerateQR" onclick="btnGenerateQR()"><i class="bx bx-qr-scan"></i> Generate QR</button>
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="row mb-4">
                <div class="col-md-9">
                  <div class="input-group">
                    ...
                    <button type="button" id="btnShowEntryAsset" class="btn btn-sm btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                      Show 10 
                    </button>
                ...
                <div class="col-md-3">
                  <button type="button" id="btnShowColumnAsset" class="btn btn-sm btn-outline-secondary dropdown-toggle btn-dropdown-menu" data-bs-toggle="dropdown" aria-expanded="false">
                    Displayed Column
                  </button>
                  <ul class="dropdown-menu" id="selectShowColumnTicket">
                  <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="0"><span  class="text">ID Asset</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="5"><span  class="text">Type Device</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="6"><span  class="text">ID Device Customer</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="7"><span  class="text">Serial Number</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="8"><span  class="text">Spesifikasi</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="9"><span  class="text">RMA</span></a></li>
                    <li style="cursor: pointer;"><a class="dropdown-item"><input style="margin: 0 10px 0 5px;" type="checkbox" onclick="changeColumnTable(this)" data-column="10"><span  class="text">Client</span></a></li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h6 class="modal-title">Assign Engineer</h6>
        </div>
        <div class="modal-body">
          <form role="form">
            <div class="form-group">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-sm btn-primary" onclick="assignBy()">Save</button>
        </div>
      </div>
    </div>
  </div>
          ...
          <form role="form">
            <div class="row listEngineerAssign">
              ...
              <div class="col-sm-1">
                <div class="form-group">
                  <label>Action</label>
                  <button class="btn btn-sm btn-danger deleteRowAssign" style="width:40px" disabled><i class="bx bx-trash"></i></button>
                </div>
              </div>
            </div>
          </form>
          <div class="form-group">
            <button class="btn btn-sm btn-primary" style="margin:0 auto;display: block;" onclick="addRowAssignEngineerAtm()"><i class="bx bx-plus" style="margin-right:5px"></i>Assign</button>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-sm btn-outline-secondary pull-left" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-sm btn-primary" id="submitAssignEngineer">Save</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h6 class="modal-title">Add Service Point</h6>
        </div>
        <div class="modal-body">
          <form role="form">
            <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-sm btn-primary" onclick="saveServicePoint()">Save</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="modal-show-Qr">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-sm btn-outline-secondary pull-left" id="printQr"><i class="bx bx-print"></i> Print QR</button>
          <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Close</button>
        </div>
      </div>
    </div>
...
@section('script')
  <script type="text/javascript">
      ...
      "columns": [
        ...
        },
        {
          ...
          render: function (data, type, row, meta){
            ...
            return '<span class="badge '+ bgColor +'" style="font-size:80%!important">'+ row.status +'</span>'
    ...
    function changeNumberEntries(number){
      $("#btnShowEntryAsset").html('Show ' + number + ' <span class="bx bx-caret-down"></span>')
    ...
    function InitiateCountDashboard(url){
      $.ajax({
        ...
        success:function(response){
          ...
          $("#countAll").closest("div").next(".icon").html("<i class='bx bx-table'></i>")

          $("#countInstalled").text(response.countInstalled)
          $("#countInstalled").next().remove()
          $("#countInstalled").closest("div").next(".icon").html("<i class='bx bx-gear'></i>")

          $("#countAvailable").text(response.countAvailable)
          $("#countAvailable").next().remove()
          $("#countAvailable").closest("div").next(".icon").html("<i class='bx bx-archive'></i>")
          $("#countRent").text(response.countRent)
          $("#countRent").next().remove()
          $("#countRent").closest("div").next(".icon").html("<i class='bx bx-list'></i>")
