...
<body class="bodyEmail">
	...
	<div class="bodyBAST">
		...
		<h6 style="text-align: center;"><b>BERITA SERAH TERIMA ASSET PERUSAHAAN <br> PT SINERGY INFORMASI PRATAMA</b></h6>
		...
		<div style="width: 100%; margin-top: 50px;">
		  <div style="float: left; text-align: center; width: 45%;">
		    ...
		    <h6 style="margin-top: 10px;">{{$pihak_pertama->name}}</h6>
		  </div>
		  <div style="float: right; text-align: center; width: 45%;">
		    <img src="{{$pihak_kedua->ttd}}" style="width: 100px; height: 100px;">
		    <h6 style="margin-top: 10px;">{{$pihak_kedua->name_pk}}</h6>
		  </div>
		</div>
	</div>
</body>
