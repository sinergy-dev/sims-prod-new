...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <section class="content">
      <div class="row">
        <div class="col-md-12 col-xs-12" id="card-table-asset">
          <div class="card card-primary">
            <div class="card-header">
              <div class="row">
                <div class="col-md-6">
                  <button class="btn btn-sm btn-outline-primary" onclick="btnAddAssetScheduling()"><i class="bx bx-plus"></i> Asset Scheduling</button>
                </div>
                <div class="col-md-6">
                  <div class="input-group" style="margin-right:10px">
                    <input id="searchBar" type="text" class="form-control" placeholder="Search Anything..." onkeyup="searchBarEntries('table-asset-scheduling',this.value)">
                      <button type="button" id="btnShowEntryAsset" class="btn btn-outline-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                        Show 10 
                      </button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h6 class="modal-title">Add Asset Scheduling</h6>
        </div>
        <div class="modal-body">
              ...
              <div class="divPid" style="display:none;">
                ...
                <div class="col-md-1">
                  <div class="form-group">
                    ...
                    <button class="btn btn-flat btn-danger deleteRowAsset" style="width:40px" disabled><i class="bx bx-trash"></i></button>
                  </div>
                </div>
              </div>
          ...
          <div class="form-group">
            <button class="btn btn-md btn-outline-primary" style="margin:0 auto;display: block;" onclick="addRowAddSchedule()"><i class="bx bx-plus" style="margin-right:5px"></i> Asset</button>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-flat btn-danger" data-bs-dismiss="modal">Close</button>
...
<script type="text/javascript">
  ...
  var table = $("#table-asset-scheduling").DataTable({
    ...
    columns: [
      ...
      {
        render: function ( data, type, row){
          return "<button onclick='deleteScheduling("+ row.id +")' class='btn btn-sm btn-danger' style='width:35px;height:30px'><i class='bx bx-trash'></></button>"
        }
      }
    ],
    "aaSorting": [],
  ...
  function format(d) {
    ...
    //You can perform your desired function out here
      append = append + '<tr>' 
        ...
        append = append +   '<td>'+ "<span class='badge text-bg-success'>"+ item.status +"</span>"+'</td>'
      append = append + '</tr>'
    })
    append = append +'</table>' 
    return append;
