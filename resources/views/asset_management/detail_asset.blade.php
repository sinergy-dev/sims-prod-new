    ...
    <section class="content">
      <div class="card card-primary mb-4">
        <div class="card-body">
          <fieldset class="fieldsetDivAssetDetail">
            <div class="row mb-4 divAsset">
              ...
              <div class="col-lg-4 col-xs-12">
                ...
                <div class="form-group" style="display: none!important;">
                  ...
                  <span class="help-block" style="display:none!important">Please Fill Reason! (for rent/unavailable status)</span>
                </div>
              </div>
            </div>

            <hr>
            <div class="row mb-4 divAsset" style="display:none!important;">
            ...
            <div class="row mb-4 divPeripheral" style="margin-bottom:50px;display:none!important;">
              <div class="col-lg-4 col-xs-12">
                <!--   <div class="form-group">
          ...
          <!-- <div style="position: absolute;bottom: 0;left: 0;padding-left: 15px;padding-bottom: 20px;display: none!important;" class="divPeripheral" id="divBtnAssign"> -->
          <div class="form-group" style="margin-top:50px">
            <div style="position: absolute;bottom: 0;left: 0;padding-left: 15px;padding-bottom: 20px;display: none!important;" id="divBtnAssign">
              <button class="btn btn-sm btn-primary" style="width:150px;" onclick="AssignPeripheral()" id="btnAssignPeripheral">Assign</button>
            </div>

            <div style="position: absolute;bottom: 0;right: 0;padding-right: 15px;padding-bottom: 20px;display: none!important;" id="divBtnUpdate">
              <button class="btn btn-sm btn-danger" style="width:150px;margin-right: 10px;" onclick="resetData()">Cancel</button>
              <button class="btn btn-sm btn-warning" style="width:150px;" id="updateAsset">Update Asset</button>
            </div>
          </div>
        </div>
      </div>

      <div class="card card-primary mb-4" id="boxDetailAsset" style="display:none!important;">
        <div class="card-header with-border">
          <h6 class="card-title"><strong>Detail Asset</strong></h6>
        </div>
        <div class="card-body">
          <fieldset class="fieldsetDivAssetDetail">
            <div class="row mb-4 divAsset" style="margin-bottom:50px;display:none!important;">
              <div class="col-lg-6 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <span class="help-block" style="display:none!important;">Please fill Detail Address!</span>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input class="form-control" placeholder="" type="text" id="distance" name="distance" disabled value="0">
                    <div class="input-group-text" style="background-color:#eee">
                      <strong>KM</strong>
                    </div>
                  </div>
                </div>
                ...
                <div id="DocNonInternalContainer">
                  <div class="form-group">
                    ...
                    <span class="help-block" style="display:none!important;">Please fill Penawaran Harga!</span>
                    <span style="display:none!important;" id="span_link_drive_bukti_asset"><a id="link_bukti_asset" target="_blank"><i class="bx bx-link"></i>&nbspLink drive</a></span>
                  </div>
                </div>
              </div>            
              ...
              <div class="col-lg-6 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <span class="text-red" style="display:none!important;">Please fill New Installed Date!</span>
                </div>
                ...
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <span class="help-block" style="display:none!important;">Please fill License Start!</span>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <span class="help-block" style="display:none!important;">Please fill License End!</span>
                    </div>
                  </div>
                </div>

                <div id="DocInternalContainer" style="display:none!important;">
                  <div class="form-group">
                    <label>Bukti Asset</label>
                    <div style="border: 1px solid #dee2e6 !important;padding: 5px;color: #337ab7;">
                    ...
                    <span class="help-block" style="display:none!important;">Please fill Bukti Asset!</span>
                    <span style="display:none!important;" id="span_link_drive_bukti_asset_internal"><a id="link_bukti_asset_internal" target="_blank"><i class="bx bx-link"></i>&nbspLink drive</a></span>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <span class="help-block" style="display:none!important;">Please fill Berita Acara!</span>
                    <span style="display:none!important;" id="span_link_drive_berita_acara"><a id="link_berita_acara" target="_blank"><i class="bx bx-link"></i>&nbspLink drive</a></span>
                  </div>
                </div>
                ...
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <span class="help-block" style="display:none!important;">Please fill Maintenance Start!</span>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <span class="help-block" style="display:none!important;">Please fill Maintenance End!</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="row mb-4">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="inputSLAUptime" name="inputSLAUptime" disabled>
                      <span class="help-block" style="display:none!important;">Please fill License Start!</span>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input autocomplete="off" type="" class="form-control" id="inputTotalTicket" name="inputTotalTicket" disabled>
                      <span class="help-block" style="display:none!important;">Please fill Total Ticket!</span>
                    </div>
                  </div>
                </div>
          ...
          <div style="position: absolute;bottom: 0;right: 0;padding-right: 15px;padding-bottom: 20px;display: none!important;" id="divBtnUpdateDetail">
            <button class="btn btn-sm btn-danger" style="width:150px;margin-right: 10px;" onclick="resetData()">Cancel</button>
            <button class="btn btn-sm btn-warning" style="width:150px;" id="updateAssetDetail">Update Detail</button>
          </div>
        </div>
      </div>
      ...
      <div class="card card-primary mb-4">
        <div class="card-header">
          <h6 class="card-title"><strong>History Project ID</strong></h6>
        </div>
        <div class="card-body">
      ...
      <div class="card card-primary mb-4">
        <div class="card-header">
          <h6 class="card-title"><strong>Change Log</strong></h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
      ...
      <div class="card card-primary mb-4" style="display:none!important;" id="ticketHistoryContainer">
        <div class="card-header">
          <h6 class="card-title"><strong>Ticket History</strong></h6>
        </div>
        <div class="card-body">
          <div class="table-responsive">
              ...
              if (Array.isArray(row.document_name)) {
                for (let i = 0; i < row.document_name.length; i++) {
                  ...
                  if (docBAST.includes("Pengembalian")) {
                    return `<a href="${driveBAST}" target="_blank"><i class="bx bx-link"></i> ${docBAST}</a>`;
                  }
                }
              }
              return '-';
              ...
              append = append +'<tr>'
                append = append +'<td style="border-top: none;padding-left: 0px;width: 90%;">'
                  append = append +'<div class="form-group">'
                    ...
                    append = append +'<input class="form-control" id="inputSerialNumber" name="inputSerialNumber" disabled value="'+ text +'">'
                  append = append +'</div>'
                append = append +'</td>'
                append = append +'<td style="border-top: none;">'
                  append = append +'<button class="btn btn-sm btn-danger" style="width: 35px;height: 33px;margin-top: 10px;float: right;" onclick="deletePeripheral(' + "'" + data.id + "'" +')"><i class="bx bx-trash"></i></button>'
                append = append +'</td>'
              append = append +'</tr>'
            })
