  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Purchase Request Product(Supplier)</h6>
        </div>
...
<div class="modal fade" id="modal_product_customer" role="dialog">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Purchase Request Product(Customer)</h6>
        </div>
        <div class="modal-body">
            <div class="form-group">
...
<div class="modal fade" id="modal_pr_asset" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Add Purchase Request Asset</h6>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="modal_pr_asset_edit" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Edit Purchase Request Asset</h6>
        </div>
        <div class="modal-body">
        ...
        <div class="modal-body">
          <form action="{{url('assign_to_hrd_pr_asset')}}" method="POST">
            ...
            <div style="text-align: center;">
              <h6>Are you sure?</h6><br><h6>Submit To HRD</h6>
            </div>
          <div class="modal-footer">
