  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header">        
          <button id="btnAdd" type="button" class="btn btn-success btn-sm float-right  margin-left-custom" data-target="#modalAdd" data-toggle="modal" style="display: none;"><i class="fa fa-plus"></i> &nbspClaim</button>
          <button id="btnExport" type="button" class="btn btn-warning btn-sm dropdown-toggle float-right  margin-left-custom" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="display: none;">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content modal-md">
            <div class="modal-header">
              <h6 class="modal-title">Add Claim</h6>
            </div>
  ...
  <!-- MODAL EDIT -->
   <div class="modal fade" id="modaledit" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content modal-md">
          <div class="modal-header">
            <h6 class="modal-title">Edit Claim</h6>
          </div>
          <div class="modal-body">
...
@section('script')  
  ...
  $(document).ready(function(){
      ...
      if (accesable.includes('btnSubmitHRD') == true) {
      ...
      }else if (accesable.includes('btnSubmitAdmin') == true) {
        ...
        var column3 = table.column(11);
        column3.visible(!column3.visible());
      }else if (accesable.includes('btnSubmitFinance') == true) {
      ...
      console.log(accesable.includes('btnSubmitAdmin'))
  })
    ...
    "columns": [
      ...
      { "data": "remarks" },    
      {
        render: function ( data, type, row ) {
           if (row.status == 'HRD') {
              return '<button class="btn btn-xs btn-warning btn-submit-finance" id="btnSubmitHRD" value="'+row.id_ems+'" style="width:60px;">Submit</button>';
            }else{
