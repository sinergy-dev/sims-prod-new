...
@section('content')
  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header">
        <div class="box-header with-border">
          <h6 class="box-title">Detail Claim - {{ $tampilkan->no }}</h6>
        </div>
      </div>
      ...
      <div class="box-body">
        <div class="box-body">
          ...
          <h6 class="pull-left">{{ $tampilkan->description }}</h6>
          <h6 class="pull-right">Personnel : <i>{{$tampilkan->name}}</i></h6><br><br>
          
          <h6>ID Project : <i>{{$tampilkan->id_project}}</i></h6>
          <h6>Type : <i>{{$tampilkan->type}}</i></h6>
    ...
    <div class="box">
        <div class="box-header with-border">
          <h6 class="box-title">Progress</h6>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Return</h6>
        </div>
