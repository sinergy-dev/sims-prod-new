            ...
            <table class="table table-bordered" id="data_Table" width="100%" cellspacing="0">
              ...
              <tbody id="products-list" name="products-list">
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-primary fa fa-pencil fa-lg" data-target="#modaledit" data-toggle="modal" style="width: 40px;height: 40px;text-align: center;" onclick="edit_do('{{$data->no}}','{{$data->to}}','{{$data->attention}}','{{$data->title}}','{{$data->project}}','{{$data->description}}', '{{$data->project_id}}')">
                    </button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Add Number Delivery Order</h6>
        </div>
...
<div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Edit Delivery Order</h6>
        </div>
        <div class="modal-body">
...
@section('script')
  ...
  <script type="text/javascript">
    function edit_do(no,to,title,attention,project,description,project_id) {
      $('#edit_no_do').val(no);
      $('#edit_to').val(to);
