...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh6u" crossorigin="anonymous">
        <style>
            h1,h2,h6,h6,p,span,div { 
                font-family: Tahoma; 
            }
    ...
    <body>
        ...
        <h6 style="text-align: center;"><b>PURCHASE REQUEST</b></h6>
        <h6><u>Supplier:</u></h6>
        ...
        <table style="width: 100%; font-size: 6pt; border-collapse: collapse; border: 1px solid black;">
            ...
            <tfoot style="background-color: #e2e2e2">
                ...
                <tr>
                    ...
                    <th></th>
                    <th></th>
                    <th style="text-align: center">{{$pph6}}{{$data->pph}}%</th>
                </tr>
                <tr>
                    <th></th>
                    <th></th>
