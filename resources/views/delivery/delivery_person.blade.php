...
<section class="content">
	<div class="box">
      <div class="box-header with-border">
        <h6 class="box-title"><i class="fa fa-table"></i>&nbsp<b>Delivery Person & Messenger</b></h6>
      ...
      <div class="modal-dialog modal-md">
        ...
        <div class="modal-content modal-md">
          <div class="modal-header">
            <h6 class="modal-title">Add Booking Messenger</h6>
          </div>
    ...
    <div class="modal fade" id="modaleditmessenger" role="dialog">
      <div class="modal-dialog modal-md">
        ...
        <div class="modal-content modal-md">
          <div class="modal-header">
            <h6 class="modal-title">Edit Booking Messenger</h6>
          </div>
          <div class="modal-body">
