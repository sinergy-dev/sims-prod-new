...
<section class="content-header">
  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-6">
      	<div class="box box-solid box-default">
      		<div class="box-header">
      			<h6 class="box-title"><i class="fa fa-info"></i>) Details - 
      				@if($tampilkan->result == "")
	         ...
	         <!--  <div class="">
	            <h6 class="pull-right">Owner : <i>{{$tampilkan->name}}</i></h6>
	            <h6 class="pull-left">{{ $tampilkan->customer_legal_name }}</h6><br><br>
	            <h6>{{$tampilkan->opp_name}}</h6>
	          </div>
	          <div class="">
	          	@if(Auth::User()->id_company == '1')
	              @if($tampilkan_com->id_company == '1')
	                <h6>Current Presales : <i>{{$tampilkans->name}}</i></h6>
	              @elseif($tampilkan_com->id_company == '2')
	              <h6>Current Presales : <i>Presales</i></h6>
	              @endif
	            @else
	            <h6>Current Presales : <i>Presales</i></h6>
	            @endif
	            @if(Auth::User()->id_position == 'ENGINEER STAFF')
	            <h6>Current Engineer : <i>{{$current_eng->name}}</i></h6>
        ...
        <div class="row margin-top">
	      <div class="col-md-6">
	        <div class="box box-solid box-default">
              <div class="box-header with-border">
                <h6 class="box-title">Solution Design</h6>
          ...
          <div class="col-md-6">
            <div class="box box-solid box-default">
              <div class="box-header with-border">
                <h6 class="box-title">Tender Process</h6>
              </div>
	                ...
	                <tr>
	                  <div for="assessment" style="background-color: blue">
	                    <div class="box box-header with-border">
	                      <h6 class="box-title">As Contribute</h6>
	                      @if(Auth::User()->id_division == 'TECHNICAL PRESALES' && $tampilkans->status != 'closed' && Auth::User()->name == $tampilkans->name)
	    ...
	    <div class="col-md-12">
	          ...
	          <fieldset >
			      <div class="box" id="purchase-order">
			          @endif
				      <div class="box-header with-border">
				          <h6 class="box-title">Purchase Order Customer</h6>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
            <h6 class="box-title">Change Log</h6>
              <div class="pull-right">
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Purchase Order Customer</h6>
        </div>
  ...
  <div class="modal fade" id="modal_edit_po" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Edit Purchase Order Customer</h6>
        </div>
        <div class="modal-body">
            ...
            <form method="POST" action="{{url('update_result')}}" id="modalResult" name="modalResult">
              ...
              <div class="tab active-tab">
                <div class="form-group">
                  ...
                  <h6><b>Opp Name : <i>{{$tampilkan->opp_name}}</i></b></h6>
                  <div>
        ...
        <div class="modal-body">
          <form action="{{url('raise_to_tender')}}" method="POST">
            ...
            <div style="text-align: center;">
              <h6>Are you sure?</h6><br><h6>RAISE TO TENDER</h6>
            </div>
          <div class="modal-footer">
...
>>>>>>> 2630783529c42e098fe1f3f8590633739c0abd79
  ...
  <div class="modal fade" id="contributeModalPMO" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Contribute PMO</h6>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="contributeModalEngineer" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content modal-md">
        <div class="modal-header">
          <h6 class="modal-title">Contribute Engineer</h6>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="keterangan" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Progress</h6>
        </div>
        <div class="modal-body">
    ...
    <script type="text/javascript">
      ...
      $('#date_po_result').datepicker({
    	...
    	if (moment(date.date).format("YYYY") < 2020) {
    		swal.fire("<h6>Warning Pembuatan PID!!!</h6>", "<h6>lead dengan tanggal PO tahun lalu (backdate) harap kirim email manual pada Bu Anne untuk pembuatan PID seperti proses manual terdahulu! Dikarenakan semua PID yang melalui sistem hanya di peruntukkan untuk tanggal PO di tahun ini</h6>")
