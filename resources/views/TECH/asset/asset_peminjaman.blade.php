      ...
      <div class="nav-tabs-custom active" id="asset" role="tabpanel">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane" id="kategori_tab" role="tabpanel" aria-labelledby="kategori-tab">
             <div class="box box-primary">
              <div class="box-header with-border">
                <h6 class="box-title"><i class="fa fa-table"></i> Kategori Asset </h6>
          ...
          <div class="tab-pane" id="list_asset" role="tabpanel" aria-labelledby="home-tab">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h6 class="box-title"><i class="fa fa-table"></i> Warehouse Asset </h6>
                <div class="box-tools pull-right">
                  <!-- Collapse Button -->
                  <button type="button" class="btn btn-box-tool" data-widget="collapse">
                    <i class="fa fa-minus"></i>
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h6 class="box-title"><i class="fa fa-table"></i> Activity log </h6>
                <div class="box-tools pull-right">
                  <!-- Collapse Button -->
                  <button type="button" class="btn btn-box-tool" data-widget="collapse">
                    <i class="fa fa-minus"></i>
          ...
          <div class="tab-pane" id="peminjaman_tab" role="tabpanel" aria-labelledby="profile-tab">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h6 class="box-title"><i class="fa fa-table"></i> Peminjaman Asset </h6>
                <div class="box-tools pull-right">
                  <!-- Collapse Button -->
                  <button type="button" class="btn btn-box-tool" data-widget="collapse">
                    <i class="fa fa-minus"></i>
...
<div class="modal fade" id="add_asset" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Add Asset Engineer</h6>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Update Asset Engineer</h6>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="peminjaman_modal" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Peminjaman</h6>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="pengembalian" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title">Pengembalian</h6>
        </div>
        <div class="modal-body">
      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <h6>Please Select Serial Number: <input type="" class="qtysn" name="qty" id="qty" style="border-style: none;width: 250px;" readonly></h6><br>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <!-- <input type="text" name="id_transaction_update" id="id_transaction_update" hidden> -->
          <div class="form-group">
            <h6 style="text-align: center;"><b>Are you sure to delete product?</b></h6>
          </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fa fa-times"></i>&nbspCANCEL</button>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="form-group">
            <h6 style="text-align: center;"><b>PICK UP NOW!</b></h6>
          </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fa fa-times"></i>&nbspCANCEL</button>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="form-group">
            <h6 style="text-align: center;"><b>RETURN NOW!</b></h6>
